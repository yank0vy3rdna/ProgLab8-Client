    ...
    void initialize() {
        ...
        Update.setOnAction(event->{
            try {
                ...
                dragon = new Dragon(name.getText(), Main.cord, Long.parseLong(age.getText()), Long.parseLong(weight.getText()), DragonType.valueOf(dragonType.getValue()), DragonCharacter.valueOf(dragonCharacter.getValue()), Main.killer, Main.owner_id);
                out.setDragon(dragon);
